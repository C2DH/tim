      ...
      <View>
        <Well marginX="size-500">
          <p>
            ...
            eget diam. Morbi tempus eu neque et aliquam. Etiam et sapien libero. Suspendisse et sapien varius, mollis
            diam quis, mollis enim. Nunc a ex eu erat egestas feugiat. Quisque tempor blandit diam, id eleifend ligula
            vehicula sit amet. Pellentesque vestibulum pretium rhoncus. Pellentesque nec suscipit elit, ut cursus quam.
            Praesent eleifend nisi justo, eget rutrum sapien luctus cursus. Mauris elementum condimentum lorem vitae
            auctor.
          </p>
          <p>
            In eget feugiat lorem, a convallis diam. Sed tempus maximus purus eu ornare. Cras rutrum ipsum ut purus
            tristique pharetra. Nullam tortor magna, imperdiet id faucibus vitae, rutrum et enim. Pellentesque dolor
            leo, dictum nec justo feugiat, elementum luctus libero. Maecenas nec pulvinar tellus, eget efficitur ipsum.
            Duis risus urna, facilisis vitae vulputate sed, vestibulum at augue. Fusce at tincidunt mauris. Aenean nisl
            leo, aliquet finibus tortor sit amet, pretium finibus felis. Aliquam fringilla sollicitudin urna, nec semper
            dolor faucibus ut.
          </p>
        </Well>
      </View>
