...
const Intro = () => (
  <View marginX="size-500">
    <p>
      ...
      . TIM also allows for free-form notetaking for casual users or professional researchers to manage a/v content in a
      timecode-linked environment.
    </p>
    <p>
    ...
    <div style={{ marginTop: 100 }}>
      ...
      <a href="https://theirstory.io/" target="_blank" rel="noopener noreferrer">
        <img
          src="assets/TheirStory_Logo_Clean.png"
          alt="TheirStory logo"
          height="100"
